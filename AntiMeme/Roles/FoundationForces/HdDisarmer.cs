...
/// <summary>拘束銃を扱う Nu-7 拘束兵です。</summary>
public class HdDisarmer : FoundationRole
{
    public override string Name => "ハンマーダウン 拘束兵";

    /// <inheritdoc/>
    public override string HudLabel => "<color=#353535>MTF Nu-7: Disarmer</color>";
    public override string Description => "当たると拘束できるスナイパーライフルを所持したNu-7の歩兵。\n敵の自由を奪い制圧を助ける。";
    public override RoleTypeId BaseRole => RoleTypeId.NtfPrivate;
    public override float? MaxHealth => 110f;
    public override string CustomInfo => "<color=#727472>Hammer Down Disarmer</color>";
    ...
    public override IReadOnlyList<Type> CustomItems => [typeof(GunDisarmerRifle), typeof(ArmorInfantry)];
